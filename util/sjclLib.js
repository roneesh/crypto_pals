...
//this is for generating a key from the pw, which will then encrypt other data
var KDF = function(password, salt) {
  return sjcl.misc.pbkdf2(password, salt, 100000);
  // Takes about a second on a commodity laptop.
};
// You can just run SHA256(KDF()) to get multiple keys
...
// Roneesh implemented
var bitarray_xor = function(a1, a2) {
  if (a1.length !== a2.length) {
    throw "bitarray_xor: lenghts are not equal";
  }
  var xor = [];
...
module.exports.bitarray_xor = bitarray_xor;